...
func main() {
	var num int64 = 10 // Начальное значение переменной
	var i int = 3      // Индекс бита (считая с 0 слева направо)
	var setTo int = 1  // Установить бит в 1 (для 0 использовать 0)
	...
	fmt.Printf("Число: %b\n", num) // Вывод числа в двоичном формате
}
